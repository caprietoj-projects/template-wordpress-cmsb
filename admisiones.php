<?php
/*
 Template Name: admisiones_template
 Template Post Type: page
*/
?>
<?php get_header( 'admisiones' ); ?>
            ...
            <div class="col">
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th><a href="<?php echo get_theme_mod( 'link_contacto', '#' ); ?>" target="_blank"><img data-bss-hover-animate="tada" src="<?php echo PG_Image::getUrl( get_theme_mod( 'actores_contactos', esc_url( get_template_directory_uri() . '/assets/img/Contactenos-Wattsapp.png' ) ), 'medium' ) ?>" style="width: 150px;"></a></th>
