<body style="background: url("<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/fondoiconos.png");background-size: cover;background-image:<?php echo 'url('.PG_Image::getUrl( get_theme_mod( 'fondo_cuadros' ), 'full' ).')' ?> !important;" class="<?php echo implode(' ', get_body_class()); ?>">
